...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -g -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -Wall -Wextra
END


BEGIN DRIVER
 PARAMETER DRIVER_NAME = fastsad
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = fastsad_0
END
