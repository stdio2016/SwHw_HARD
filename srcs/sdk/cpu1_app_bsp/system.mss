...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -DUSE_AMP=1 -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -Wall -Wextra
END


BEGIN DRIVER
 PARAMETER DRIVER_NAME = my_sync
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = my_sync_0
END
