...
proc update_PARAM_VALUE.MY_BUF_ADDR_WIDTH { PARAM_VALUE.MY_BUF_ADDR_WIDTH } {
	# Procedure called to update MY_BUF_ADDR_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MY_BUF_ADDR_WIDTH { PARAM_VALUE.MY_BUF_ADDR_WIDTH } {
	# Procedure called to validate MY_BUF_ADDR_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.MY_BUF_ADDR_WIDTH { MODELPARAM_VALUE.MY_BUF_ADDR_WIDTH PARAM_VALUE.MY_BUF_ADDR_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MY_BUF_ADDR_WIDTH}] ${MODELPARAM_VALUE.MY_BUF_ADDR_WIDTH}
}
